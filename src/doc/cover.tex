...
\begin{frame}[plain,noframenumbering]
	...
	\end{minipage}
	\note{
		En éste webinar se presenta en dos partes, por un lado presentaremos el libro: Las matemáticas en la vida real, introducción básica al modelamiento matemático y en segundo lugar se hará una presentación de la biblioteca modular DUNE.
	}
\end{frame}
}