...
\title{
	...
	\texttt{C++}/\texttt{Python} para la solución de modelos
	matemáticos
}
...
\newcommand{\gpllicense}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`\B]{gpl-v3-logo}%
	\endgroup
}
...
\newcommand{\pythonlogo}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`\B]{python}%
	\endgroup
}

\newcommand{\cpplogo}{%
	\begingroup\normalfont
	\includegraphics[height=2\fontcharht\font`\B]{cpp}%
	\endgroup
}
